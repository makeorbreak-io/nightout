# Generated by Django 2.0.4 on 2018-04-15 13:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses_bought', to=settings.AUTH_USER_MODEL)),
                ('debtors', models.ManyToManyField(related_name='expenses', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Friends',
        ...
        migrations.AddField(
            model_name='expenses',
            name='night',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='mainsite.Night'),
        ),
        migrations.AddField(
            model_name='expenses',
            name='user',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='owes', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
